...
1. **원본 레포지토리 접속**
   - 예: [https://github.com/HUFS-LAI-Seungtaek/HUFS-LAI-ML-2025-2](https://github.com/HUFS-LAI-Seungtaek/HUFS-LAI-ML-2025-2)
...
3. **내 레포지토리 확인**
   ...
   - URL이 `https://github.com/{내_계정명}/HUFS-LAI-ML-2025-2`로 바뀜
...
```bash
# HTTPS로 클론 (권장)
git clone https://github.com/{내_계정명}/HUFS-LAI-ML-2025-2.git
